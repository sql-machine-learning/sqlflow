...
public abstract class BaseParser implements ParseInterface {
   ...
   * @return -1 on successfully parse the statement,
   *   otherwise return where error occurs
   * @throws Exception means impossible to parse
   */
  protected abstract int parseOneStmt(String statement) throws Exception;
   ...
   * we will calculate length base on the result.
   *
