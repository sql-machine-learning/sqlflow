...
# Note: this script is supposed to run from a Dockerfile to install pre-built
# SQLFlow server in ./build on the host into a Docker image.
pip install --quiet /build/*.whl
