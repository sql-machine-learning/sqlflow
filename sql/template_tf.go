...
def input_fn(datasetStr):
    ...
    gen = db_generator(driver, conn, sessionCfg, datasetStr, feature_column_names, "{{.Y.FeatureName}}", feature_metas)
...
def eval_input_fn(batch_size):
    ...
    gen = db_generator(driver, conn, sessionCfg, """{{.PredictionDataset}}""",
...
column_names = feature_column_names[:]
column_names.append("{{.Y.FeatureName}}")
pred_gen = db_generator(driver, conn, sessionCfg, """{{.PredictionDataset}}""", feature_column_names, "{{.Y.FeatureName}}", feature_metas)()
